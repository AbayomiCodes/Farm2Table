  ...
  final List<Map<String, dynamic>> dummyProducts = [
    {
      'name': 'Fresh Tomatoes',
      'price': 'GHS 100',
      'image_placeholder': Colors.orange[100],
      'weight_quantity': '140 kg',
      'unit': 'per kg',
      'available': 'available',
    },
    {
      'name': 'Avocado',
      'price': 'GHS 25',
      'image_placeholder': Colors.red[100],
      'weight_quantity': '40 kg',
      'unit': 'per kg',
      'available': 'available',
    },
    {
      'name': 'Eggs',
      'price': 'GHS 4',
      'image_placeholder': Colors.yellow[100],
      'weight_quantity': '900 g (Crate)',
      'unit': 'per kg',
      'available': 'available',
    },
    {
      'name': 'Oranges',
      'price': 'GHS 10',
      'image_placeholder': Colors.amber[100],
      'weight_quantity': '25 kg',
      'unit': 'per kg',
      'available': 'available',
    },
    {
      'name': 'Yam',
      'price': 'GHS 70',
      'image_placeholder': Colors.blue[100],
      'weight_quantity': '160 kg',
      'unit': 'per kg',
      'available': 'available',
    },
    {
      'name': 'Grains',
      'price': 'GHS 30',
      'image_placeholder': Colors.green[100],
      'weight_quantity': '50 kg',
      'unit': 'per kg',
      'available': 'available',
    },
  ];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Direct from your local farmers to your table',
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => ProductDetails(
                                      ...
                                      weight:
                                          dummyProducts[index]['weight_quantity'],
                                      color:
                                          dummyProducts[index]['image_placeholder'],
                                    ),
                                  ),
                                );
                              },
